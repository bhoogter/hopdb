...
function hopdb_do_write_feeds()
	{
	file_put_contents(hopdb_feed_file("kml"), hopdb_kml());
	file_put_contents(hopdb_feed_file("xml"), hopdb_xml());
	}

function hopdb_kml_encode($s) {return str_replace(array("<",">","&"), array("&lt;","&gt;","&amp;"), $s);}
